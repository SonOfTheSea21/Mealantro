        ...
        {replies && replies.length > 0 && (
          <div style={{ marginLeft: "20px" }}>
            {replies.map(reply => (
              <Comment
                key={reply.id}
                profilePictureSrc={reply.profilePictureSrc == null ? "https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" : reply.user_photo}
