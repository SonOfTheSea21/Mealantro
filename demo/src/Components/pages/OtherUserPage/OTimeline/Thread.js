  ...
  const fetchComments = async () => {
    try {
      ...
      const formattedComments = response.data.data.map(comment => ({
        ...
        profilePictureSrc: comment.user_photo, // Assuming user_photo is the profile picture
    ...
    <div className="media-block">
      ...
      <div className="media-body">
        ...
        {comments.map((comment) => (
          ...
          <Comment
            key={comment.id}
            profilePictureSrc={comment.profilePictureSrc == null ? "https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" : comment.user_photo}
